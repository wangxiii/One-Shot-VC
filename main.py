...
if __name__ == '__main__':
    ...
    parser.add_argument('-store_model_path', default='/work/b07u1234/b07505026/try2/model/try2')
    parser.add_argument('-load_model_path', default='/work/b07u1234/b07505026/try2/model/try2')
